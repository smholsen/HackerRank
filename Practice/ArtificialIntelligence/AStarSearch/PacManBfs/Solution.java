package Practice.ArtificialIntelligence.AStarSearch.PacManBfs;
...
public class Solution {
    ...
    private static void bfs(int r, int c, int posr, int posc, int food_r, int food_c, String[] board) {
    ...
    private static void findGoal(int[] current, Node[][] board) {
        ...
        queued.add(board[current[0]][current[1]]);
        while (!q.isEmpty()) {
            Node c = q.poll();
            explored.add(c);
            if (c.data == '.') {
